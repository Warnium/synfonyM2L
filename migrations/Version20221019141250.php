 ...
 */
final class Version20221019141250 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD adresse_id INT NOT NULL, ADD nom LONGTEXT NOT NULL, ADD prenom LONGTEXT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP adresse_id, DROP nom, DROP prenom');
    }
}
